...
def main():
    parser = argparse.ArgumentParser(description='Check if the source is newer than the target')
    parser.add_argument('targets', type=str, nargs='+', help='Target files or directories')
